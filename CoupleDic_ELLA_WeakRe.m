function [yp_tr,yp_te,ytr,yte,yp,ype,ACTpT] = CoupleDic_ELLA_WeakRe(x_tr,y_tr,x_te,y_te,k, rho,rho2, rou,single_lifelong_sign)
...
for t=1:T_max
    ...
    theta2{t}=prect(1:me_num2,:)*theta1{t};
